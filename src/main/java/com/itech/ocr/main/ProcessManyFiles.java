...
import com.itech.ocr.ocr.Client;
import com.itech.ocr.ocr.ProcessingSettings;
import com.itech.ocr.ocr.Task;
...
public class ProcessManyFiles {
	...
	private static void displayHelp() {
		System.out.println(
			...
			"    java com.itechart.recognizer.main.ProcessManyFiles recognize <imagesDir> <resultDir>\n" +
			"  2. Recognize files from url (experimental):\n" +
			"    java com.itechart.recognizer.main.ProcessManyFiles remote <imageUrl> <resultDir>\n" +
			"  3. Recognize many files from urls in a file (experimental):\n" +
			"    java com.itechart.recognizer.main.ProcessManyFiles remote <urlFilePath> <resultDir>\n" +
			"\n" +
			"For detailed help, call\n" +
			"  java com.itechart.recognizer.main.ProcessManyFiles help <mode>\n" +
	...
	private static void displayRecognizeHelp() {
		System.out.println(
			...
			+ "\n"
			+ "Usage:\n"
			+ "  java com.itechart.recognizer.main.ProcessManyFiles recognize [--lang=<languages>] [--format=<format>] <directory> <output dir>\n"
			+ "\n"
			...
			+ "\n"
			+ "Examples:\n"
			+ "java com.itechart.recognizer.main.ProcessManyFiles recognize ~/myImages ~/text\n"
			+ "java com.itechart.recognizer.main.ProcessManyFiles recognize --lang=French,Spanish --format=pdfSearchable myImages ocrPdfImages\n" );
	...
	private static void displayRemoteHelp() {
		...
		System.out.println(
			...
			+ "\n" 
			+ "Usage:\n" 
			+ "  java com.itechart.recognizer.main.ProcessManyFiles remote [--lang=<languages>] [--format=<format>] <url|file with urls> <output dir>\n"
			+ "\n"
			...
			+ "\n"
			+ "Examples:\n"
			+ "java com.itechart.recognizer.main.ProcessManyFiles remote https://github.com/abbyysdk/ocrsdk.com/blob/master/SampleData/Page_08.tif?raw=true ~/text\n"
			+ "java com.itechart.recognizer.main.ProcessManyFiles remote --lang=French,Spanish --format=pdfSearchable ~/myUrlList.txt ocrPdfImages\n" );
